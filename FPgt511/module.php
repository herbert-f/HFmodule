	...
	class FingerprintReaderGT511 extends IPSModule	{
		...
		*/
		...
		protected function EnrollStart ($Speicherplatz) {				
			...
			$this->setBuffer("Answer","Begin");
			if ($debug) IPS_LogMessage($Name,"EnrollStart gestartet für Speicherplatz $Speicherplatz");        // Command = EnrollStart Parameter = ID(0~199) If ID === -1, then “Enrollment without saving” will be stated.
